...
public class NewInterCityRoadEventBuilder extends Builder<Event>{
	...
	protected Event createTheInstance(JSONObject data) {
		NewInterCityRoadEvent nic = null;
		...
		nic= new NewInterCityRoadEvent(this.time,this.id,this.srcJunc,this.destJunc,this.length,this.co2Limit,this.maxSpeed,this.weather);
		return nic;
	}
